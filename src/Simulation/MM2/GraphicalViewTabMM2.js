...
const GraphicalViewTabMM2 = ({ calculatedData }) => {
  ...
  const customerWaitTimeDataServer1 = calculatedData.server1Data.map(
    (data) => ({
  ...
  const customerWaitTimeDataServer2 = calculatedData.server2Data.map(
    (data) => ({
      customer: data.customer,
      waitTime: data.waitTime,
    })
  ...
  const customerArrivalTimeDataServer1 = calculatedData.server1Data.map(
    (data) => ({
      customer: data.customer,
  ...
  const customerArrivalTimeDataServer2 = calculatedData.server2Data.map(
    (data) => ({
      customer: data.customer,
      arrivalTime: data.arrivalTime,
    })
    ...
    <div className="">
      ...
      <div className="flex flex-row space-x-10 justify-center">
        <div className="graph-container">
          ...
          <h4 className="">Customer vs. Wait Time (Server 1)</h4>
          <BarChart width={600} height={400} data={customerWaitTimeDataServer1}>
        ...
        <div className="graph-container">
          ...
          <h4 className="">Customer vs. Wait Time (Server 2)</h4>
          <BarChart width={600} height={400} data={customerWaitTimeDataServer2}>
            <XAxis dataKey="customer" tickLine={false} />
            <YAxis />
            <CartesianGrid strokeDasharray="" />
            <Tooltip />
            <Legend />
      ...
      <div className="flex flex-row space-x-10 justify-center">
        <div className="graph-container">
          ...
          <h4 className="">Customer vs. Arrival Time (Server 1)</h4>
          <LineChart
            width={500}
            height={300}
            data={customerArrivalTimeDataServer1}
          >
        ...
        <div className="graph-container">
          ...
          <h4 className="">Customer vs. Arrival Time (Server 2)</h4>
          <LineChart
            width={500}
            height={300}
            data={customerArrivalTimeDataServer2}
          >
            <XAxis dataKey="customer" />
            <YAxis />
            <CartesianGrid strokeDasharray="" />
